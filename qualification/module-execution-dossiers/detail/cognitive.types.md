...
- **Implemented entrypoints:** `build_snapshot` in [codex-rs/hepta-cognitive-types/src/lib.rs](../../../codex-rs/hepta-cognitive-types/src/lib.rs); `CognitiveSnapshotKeyV1` in [codex-rs/hepta-cognitive-types/src/lane_c.rs](../../../codex-rs/hepta-cognitive-types/src/lane_c.rs); production HNMF V1 contracts in [codex-rs/hepta-cognitive-types/src/hnmf/mod.rs](../../../codex-rs/hepta-cognitive-types/src/hnmf/mod.rs), including `ModalitySpanRefV1`, `MemoryEventV1`, `CrossModalBindingV1`, `EngramNodeV1`, `SynapseV1`, `MemoryCueV1`, `RecallPacketV1`, `OutcomeSignalV1`, `ReplaySelectionReceiptV1`, `PlasticityBatchV1`, `TopologyProposalV1`, and `ForgetPropagationReceiptV1`. The HNMF values use private fields, validated `try_new` constructors and strict canonical-JSON admission.
...
- **Source tests:** [codex-rs/hepta-cognitive-types/src/lib_tests.rs](../../../codex-rs/hepta-cognitive-types/src/lib_tests.rs), [codex-rs/hepta-cognitive-types/src/lane_c_tests.rs](../../../codex-rs/hepta-cognitive-types/src/lane_c_tests.rs), [codex-rs/hepta-cognitive-types/src/hnmf/tests.rs](../../../codex-rs/hepta-cognitive-types/src/hnmf/tests.rs), and [codex-rs/hepta-cognitive-types/tests/hnmf_reference_conformance.rs](../../../codex-rs/hepta-cognitive-types/tests/hnmf_reference_conformance.rs). The checked-in canonical JSON golden vector is [modality_span_v1.canonical.json](../../../codex-rs/hepta-cognitive-types/tests/data/modality_span_v1.canonical.json). These are test identities, not execution receipts for this documentation revision.
- **Implementation and operating references:** [codex-rs/hepta-memory/LANE_C_SQLITE.md](../../../codex-rs/hepta-memory/LANE_C_SQLITE.md).
- **Remaining work:** Compose named product consumers onto the native HNMF V1 contracts, obtain current exact-candidate qualification and independent acceptance, and keep activation/release claims false until those external gates pass. The contract reference shares one fixture with production for span/event/cross-modal contracts; non-isomorphic adaptive/runtime structures use the deterministic HNMF runtime as a semantic oracle. Neither reference is a second canonical ontology.
