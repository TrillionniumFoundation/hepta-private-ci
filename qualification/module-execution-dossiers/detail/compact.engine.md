...
- **Source tests:** [codex-rs/hepta-compact-engine/src/qualified_tests.rs](../../../codex-rs/hepta-compact-engine/src/qualified_tests.rs), `codex-rs/hepta-memory/src/qualified_compact_store_tests.rs`, and `codex-rs/hepta-cognitive-types/src/lane_c_tests.rs`. CI additionally emits exact-head test identities for source and deterministic synthetic-merge candidates.
