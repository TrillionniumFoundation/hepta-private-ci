...
- **Implemented entrypoints:** `authenticate`, `admit_authbus_message`, `enqueue_authbus_message`, `authorize_and_reserve_authbus`, `validate_authbus_reservation_for_effect`, `settle_authbus_reservation`, `retire_authbus_replay_epoch`, and candidate `consume_kv_v2_with_authbus`.
