...
- **Implemented entrypoints:** `compile` and `compile_wire` in [codex-rs/hepta-context-compiler/src/lib.rs](../../../codex-rs/hepta-context-compiler/src/lib.rs); `compile_with_requirements` in [codex-rs/hepta-context-compiler/src/requirements.rs](../../../codex-rs/hepta-context-compiler/src/requirements.rs); `compile_candidate_bound` in [codex-rs/hepta-context-compiler/src/candidate_bound.rs](../../../codex-rs/hepta-context-compiler/src/candidate_bound.rs). Source-aware compilation is now source-composed with the declared `platform.wire` dependency.
...
- **Wire ingress:** [codex-rs/hepta-context-compiler/src/wire.rs](../../../codex-rs/hepta-context-compiler/src/wire.rs) validates negotiated version, producer, generation and the registered compilation-request schema before typed decoding and `compile` entry.
- **Source tests:** [codex-rs/hepta-context-compiler/src/requirements_tests.rs](../../../codex-rs/hepta-context-compiler/src/requirements_tests.rs), [codex-rs/hepta-context-compiler/src/candidate_bound_tests.rs](../../../codex-rs/hepta-context-compiler/src/candidate_bound_tests.rs), [codex-rs/hepta-context-compiler/src/wire_tests.rs](../../../codex-rs/hepta-context-compiler/src/wire_tests.rs). These are test identities, not execution receipts for this documentation revision.
