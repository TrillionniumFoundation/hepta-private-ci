...
- **Implemented owner entrypoints:** `PromptRegistry` and factor/lifecycle mutation in [`registry.rs`](../../../codex-rs/hepta-prompt-registry/src/registry.rs) and [`registry_mutation.rs`](../../../codex-rs/hepta-prompt-registry/src/registry_mutation.rs); authenticated `admit_factor_authorized` binds reviewer, evidence, scope and exact factor semantics to an independently verified final-use token.
