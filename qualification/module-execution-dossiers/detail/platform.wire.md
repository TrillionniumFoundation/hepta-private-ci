...
- **Source tests:** V1 boundary/golden tests, V2 integrity/golden tests, negotiation/schema/stream tests, deterministic property-style decoder tests, and the cargo-fuzz harness are source evidence. [cross_runtime_tcp.rs](../../../codex-rs/hepta-wire/tests/cross_runtime_tcp.rs) adds live Python -> TCP -> Rust V2 framing, schema admission and typed loading.
