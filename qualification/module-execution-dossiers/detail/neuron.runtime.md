...
- **Canonical protocol surface:** [codex-rs/hepta-neuron/src/protocol.rs](../../../codex-rs/hepta-neuron/src/protocol.rs) now projects the registered `NeuronRuntimeConfigV1`, `NeuronTickInputV1`, `NeuronTickReceiptV1`, `NeuronSignalReceiptV1` and `NeuronCheckpointV1` JSON boundaries with unknown-critical-field rejection. The checkpoint adapter derives semantic fields from the committed owner checkpoint rather than accepting caller-authored summaries.
