...
- **Ablation and longitudinal qualification surface:** [codex-rs/hepta-neuron/src/qualification.rs](../../../codex-rs/hepta-neuron/src/qualification.rs) executes deterministic full/no-temporal/no-inhibition/no-homeostasis/no-eligibility lesions and binds preregistration, future-window, retention, unlearning/non-resurrection and independent-evaluator evidence digests. Binding evidence is not an efficacy verdict.
...
- **Remaining work:** provide and independently qualify a concrete local encoder/head driver that returns the actual Q24 drive/prediction tensors and exact weights/tokenizer/preprocessor/quantization/runtime/device evidence; bind the named consumer into the real product host; qualify any wider canonical profile such as distinct temporal/activation dimensions or per-population competition instead of weakening the native fail-closed profile; collect target-host resource measurements; execute the repository ablation harness against preregistered future/retention slices; supply independently produced future-window, retention, deletion non-resurrection and evaluator evidence to the binding surface; and obtain independent acceptance before claiming adaptive intelligence or production activation.
