...
- **Implemented entrypoints:** `rescale_signal` in [codex-rs/hepta-types/src/numeric_conversion.rs](../../../codex-rs/hepta-types/src/numeric_conversion.rs); `StableId`, `IdProfileV1` and `validate_id` in [codex-rs/hepta-types/src/identity.rs](../../../codex-rs/hepta-types/src/identity.rs); `canonical_digest_v1` in [codex-rs/hepta-types/src/canonical.rs](../../../codex-rs/hepta-types/src/canonical.rs); and `DefinitionRegistryV1` in [codex-rs/hepta-types/src/registry.rs](../../../codex-rs/hepta-types/src/registry.rs).
- **Canonical semantics:** Canonical digest V1 uses an explicit domain, nonzero schema version, typed value tags, 32-bit big-endian length framing, lexicographic UTF-8 map/field ordering and semantic array ordering. Total encoding is bounded to 256 KiB with depth and field-count ceilings. [CANONICAL_GOLDEN_V1.json](../../../codex-rs/hepta-types/CANONICAL_GOLDEN_V1.json) freezes canonical bytes and the SHA-256 oracle for independent Rust/Python/TypeScript implementations.
- **Identity and authority:** Semantic ID profiles preserve the StableId alphabet while requiring explicit execution/schema/receipt/artifact/normalization namespaces. Borrowed validation precedes bounded ownership. `AuthorityPosture` fields are private; only `DENY_ALL` is publicly constructible.
- **Registry semantics:** The schema/normalization registry is an immutable caller-supplied value, not process-global state. Definitions bind namespaced ID, nonzero version and nonzero definition digest; duplicate IDs/digests reject and digest identity resolves to a stable definition reference.
...
- **Source tests:** [canonical_tests.rs](../../../codex-rs/hepta-types/src/canonical_tests.rs), [registry_tests.rs](../../../codex-rs/hepta-types/src/registry_tests.rs), [numeric_conversion_tests.rs](../../../codex-rs/hepta-types/src/numeric_conversion_tests.rs), [identity_tests.rs](../../../codex-rs/hepta-types/src/identity_tests.rs), [bounded_tests.rs](../../../codex-rs/hepta-types/src/bounded_tests.rs) and [fixed_tests.rs](../../../codex-rs/hepta-types/src/fixed_tests.rs). These are source test identities; exact-head and merge-candidate execution receipts remain separate evidence.
- **Implementation and operating references:** [CURRENT_IMPLEMENTATION.md](../../../docs/lane-a-foundation/platform.types/CURRENT_IMPLEMENTATION.md), [PRIMITIVES_V1.md](../../../docs/lane-a-foundation/platform.types/PRIMITIVES_V1.md) and [NUMERIC_SIGNAL_CONVERSION.md](../../../codex-rs/hepta-types/NUMERIC_SIGNAL_CONVERSION.md).
- **Remaining work:** Execute exact-head and synthetic-merge qualification for this candidate, bind the resulting receipts into evidence state, and independently reproduce the frozen canonical vectors in Python/TypeScript before claiming generated cross-language bindings or production composition.
