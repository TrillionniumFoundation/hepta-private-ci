...
- **Implemented entrypoints:** `retrieve_v2` in [codex-rs/hepta-memory-retrieval/src/v2.rs](../../../codex-rs/hepta-memory-retrieval/src/v2.rs); `compile_cue` in [codex-rs/hepta-memory-retrieval/src/generation_bound.rs](../../../codex-rs/hepta-memory-retrieval/src/generation_bound.rs); `build_candidate_union` in [codex-rs/hepta-memory-retrieval/src/generation_bound.rs](../../../codex-rs/hepta-memory-retrieval/src/generation_bound.rs); `recall` in [codex-rs/hepta-memory-retrieval/src/generation_bound.rs](../../../codex-rs/hepta-memory-retrieval/src/generation_bound.rs); `build_candidate_union_from_batches` in [codex-rs/hepta-memory-retrieval/src/channel_contract.rs](../../../codex-rs/hepta-memory-retrieval/src/channel_contract.rs); `expand_candidate_engram` in [codex-rs/hepta-memory-retrieval/src/engram_expansion.rs](../../../codex-rs/hepta-memory-retrieval/src/engram_expansion.rs); `recall_with_engram` in [codex-rs/hepta-memory-retrieval/src/hnmf.rs](../../../codex-rs/hepta-memory-retrieval/src/hnmf.rs).
