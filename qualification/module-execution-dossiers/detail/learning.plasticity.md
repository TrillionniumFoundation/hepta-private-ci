...
- **Governed parameter composition:** `verify_parameter_mutation_policy_v1` and `generate_parameter_candidates_v3` in the plasticity core; `propose_authenticated_parameter_plasticity_v1` and `AnchoredPlasticityWriterV1` in [codex-rs/hepta-intelligence/src/plasticity_product.rs](../../../codex-rs/hepta-intelligence/src/plasticity_product.rs); `propose_agentd_plasticity_v1` and the Agentd anchor/fence store in `codex-rs/hepta-agentd/src/plasticity_host.rs`.
