...
- **Durable lost-ack boundary:** [codex-rs/hepta-infer-core/src/native_control.rs](../../../codex-rs/hepta-infer-core/src/native_control.rs) owns the durable native reservation/dispatch/running/cancelling/indeterminate/released record. A reopen after a possibly admitted dispatch never reconnects and replays automatically. A typed App Server rejection before a turn exists is persisted separately as `Rejected`/released without inventing terminal provider output.
