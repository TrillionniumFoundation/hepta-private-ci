...
- **Implemented entrypoints:** `thread_start` in [codex-rs/app-server/src/request_processors/thread_processor.rs](../../../codex-rs/app-server/src/request_processors/thread_processor.rs); `turn_start` in [codex-rs/app-server/src/request_processors/turn_processor.rs](../../../codex-rs/app-server/src/request_processors/turn_processor.rs); `adapt` and `adapt_wire` in [codex-rs/hepta-codex-adapter/src/lib.rs](../../../codex-rs/hepta-codex-adapter/src/lib.rs). Existing Codex App Server execution spine and receipt adapter are source-composed with the declared `platform.wire` dependency.
...
- **Wire ingress:** [codex-rs/hepta-codex-adapter/src/wire.rs](../../../codex-rs/hepta-codex-adapter/src/wire.rs) validates negotiated version, producer, generation and the registered operation-intent schema before typed decoding and `adapt` entry.
- **Source tests:** [codex-rs/hepta-codex-adapter/src/lib_tests.rs](../../../codex-rs/hepta-codex-adapter/src/lib_tests.rs), [codex-rs/hepta-codex-adapter/src/deadline_digest_tests.rs](../../../codex-rs/hepta-codex-adapter/src/deadline_digest_tests.rs), [codex-rs/hepta-codex-adapter/src/wire_tests.rs](../../../codex-rs/hepta-codex-adapter/src/wire_tests.rs). These are test identities, not execution receipts for this documentation revision.
