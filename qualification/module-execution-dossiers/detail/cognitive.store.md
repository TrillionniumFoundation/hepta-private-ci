...
- **Canonical migration:** the shadow receipt is now on this convergence line, but legacy admission evidence still lacks `source_revision`; full provenance equivalence therefore requires an authoritative durable-owner bridge rather than caller assertion.
