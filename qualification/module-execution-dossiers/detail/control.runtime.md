...
- **Named host source:** [codex-rs/hepta-supervisor/src/global_control.rs](../../../codex-rs/hepta-supervisor/src/global_control.rs) composes durable `HeptaEvidenceStore` AuthBus replay, exact fleet allocation admission, the real global planner/NDU path, `PlannerJournalStoreV1`, and the independent final-use authority fence. Its restart test reopens evidence and planner state and rejects the replayed owner sequence.
