...
- **Implemented entrypoints:** `run_read_only_vertical` in [codex-rs/hepta-intelligence/src/vertical.rs](../../../codex-rs/hepta-intelligence/src/vertical.rs); strict default `run_evaluated_shadow_v2` plus `trusted-evaluated-shadow-v1` feature-gated compatibility `run_evaluated_shadow_v1` in [codex-rs/hepta-intelligence/src/evaluated_shadow.rs](../../../codex-rs/hepta-intelligence/src/evaluated_shadow.rs). V2 binds the learning.eval durable holdout proof into both evaluation and candidate-byte signatures before invoking any host port.
