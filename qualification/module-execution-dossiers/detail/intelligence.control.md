...
- **Remaining work:** Bind the source-level composition into the named runtime host, carry compiled context through serialization/attachment to actual model dispatch and terminal delivery observation, and supply trusted current host ports/evaluation/calibration evidence. The bridge does not create another model loop, production writer or effect authority.
