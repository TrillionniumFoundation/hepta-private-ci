...
- Keep Matrix send state and terminal observations under `MatrixDurableStore` with one stable transaction identity. Transport acceptance is non-terminal; only atomic homeserver sync reconciliation can settle success.
