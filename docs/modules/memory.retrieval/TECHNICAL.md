...
- [runtime_tests.rs](../../../codex-rs/hepta-agentd/src/runtime_tests.rs): explicit `Compatibility` versus `HnmfRequired` startup behavior; the required profile rejects a missing current retrieval context.
