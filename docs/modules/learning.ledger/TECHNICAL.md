...
The registered primary source is [codex-rs/hepta-learning-ledger/src/lib.rs](../../../codex-rs/hepta-learning-ledger/src/lib.rs); observed identifiers include `DurableLedger`, `LedgerAnchor`, `LedgerRecovery`, `LearningLedger`, `ShadowDecisionRequest`, `ShadowDecisionArtifact`. This is a source navigation binding, not proof that every target operation or production consumer exists. Read the [current native implementation](../../../qualification/module-execution-dossiers/detail/learning.ledger.md#8-current-native-implementation) alongside the [module-specific implementation design](../../../qualification/module-execution-dossiers/detail/learning.ledger.md) for the implemented subset and remaining product work.
