...
The registered primary source is [apps/hepta-control-ui/src/control.js](../../../apps/hepta-control-ui/src/control.js); observed identifiers include `projectRuntime`, `buildOperationIntent`, `projectRuntimeFromLocalCanonicalJson`, `buildLocalOperationProposalFromCanonicalJson`. This is a source navigation binding, not proof that every target operation or production consumer exists. Read the [current native implementation](../../../qualification/module-execution-dossiers/detail/ui.control.md#8-current-native-implementation) alongside the [module-specific implementation design](../../../qualification/module-execution-dossiers/detail/ui.control.md) for the implemented subset and remaining product work.
