...
The registered primary source is [codex-rs/hepta-objective/src/objective_admission.rs](../../../codex-rs/hepta-objective/src/objective_admission.rs); observed identifiers include `ObjectiveAdmissionProfileV1`, `ObjectiveAdmissionContextV1`, `ObjectiveAdmissionReceiptV1`, `ObjectiveAdmissionOutcomeV1`, `admit_and_compile_objective_v1`. This is a source navigation binding, not proof that every target operation or production consumer exists. Read the [current native implementation](../../../qualification/module-execution-dossiers/detail/objective.compiler.md#8-current-native-implementation) alongside the [module-specific implementation design](../../../qualification/module-execution-dossiers/detail/objective.compiler.md) for the implemented subset and remaining product work.
