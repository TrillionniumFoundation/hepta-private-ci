...
The registered primary source is [codex-rs/hepta-plasticity/src/parameter_v2.rs](../../../codex-rs/hepta-plasticity/src/parameter_v2.rs); observed identifiers include `propose_v2`, `verify_parameter_proposal_v2`, `within_relative_limit`. This is a source navigation binding, not proof that every target operation or production consumer exists. Read the [current native implementation](../../../qualification/module-execution-dossiers/detail/learning.plasticity.md#8-current-native-implementation) alongside the [module-specific implementation design](../../../qualification/module-execution-dossiers/detail/learning.plasticity.md) for the implemented subset and remaining product work.
