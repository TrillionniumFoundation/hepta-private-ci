...
- [`state_isolation_tests.rs`](../../../codex-rs/hepta-agentd/src/state_isolation_tests.rs): stale spawn-generation final-use requests fail before store access;
- [`native_control_tests.rs`](../../../codex-rs/hepta-infer-core/src/native_control_tests.rs): durable post-dispatch/pre-`TurnStart` stop and reopen semantics;
- [`native_app_server_tests.rs`](../../../codex-rs/hepta-infer-worker-host/src/native_app_server_tests.rs): real worker fresh-context acceptance plus concurrent tombstone/correction rejection after durable dispatch and before physical `TurnStart`.
...
- Co-owner modules: `runtime.agentd`, `inference.control`, `inference.worker`.
- Allowed write paths:
- `codex-rs/hepta-cognitive-read/**`
...
- `codex-rs/hepta-agentd/src/cognitive_context_budget_tests.rs`
