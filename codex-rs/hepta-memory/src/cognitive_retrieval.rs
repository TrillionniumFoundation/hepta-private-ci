...
impl CognitiveStore {
    ...
    /// Executes retrieval and reads the exact-scope memory frontier from the
    /// same SQLite snapshot. Federation callers use this instead of inventing
    /// a frontier from returned record revisions.
