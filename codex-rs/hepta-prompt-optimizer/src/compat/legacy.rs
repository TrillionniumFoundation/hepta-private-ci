//! Legacy bounded prompt-intervention optimizer retained for migration only.
//!
//! This surface accepts caller-supplied gains and costs. It is not the canonical
//! authenticated prompt policy and must not be used by new product callers.
