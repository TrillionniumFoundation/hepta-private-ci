...
pub fn enumerate_factors_audited(
    ...
    let eligible_before_truncation =
        u32::try_from(eligible.len()).map_err(|_| PolicyError::Arithmetic)?;
...
fn price_one_factor(
    ...
    let priced_confidence_interval = PromptConfidenceIntervalV1 {
        lower_q32: estimate
            .confidence_interval
            .lower_q32
            .checked_sub(total_cost)
        ...
        upper_q32: estimate
            ...
            .checked_sub(total_cost)
            .map_err(|_| PolicyError::Arithmetic)?,
        confidence_ppm: estimate.confidence_interval.confidence_ppm,
        support_digest: estimate.confidence_interval.support_digest,
        scope_digest: estimate.confidence_interval.scope_digest,
    };
    let receipt = PromptPricingReceiptV1 {
        ...
        confidence_interval: priced_confidence_interval,
    };
