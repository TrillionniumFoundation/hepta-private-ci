...
const REQUIRED_SCHEMA_OBJECTS: &[SchemaObjectSpec] = &[
    SchemaObjectSpec {
        ...
        required_sql_fragments: &[
            "create table",
            "length(delivery_id) = 32",
            "length(key_epoch) = 8",
            "length(sequence) = 8",
            "length(expires_at_ms) = 8",
            "length(signature) = 64",
            "length(payload) <= 16384",
            "'queued', 'leased', 'acked', 'expired', 'quarantined'",
            "attempts between 0 and 16",
            "unique (issuer_id, key_epoch, message_id)",
            "without rowid",
        ],
    },
    SchemaObjectSpec {
        name: "authbus_outbox_route",
        object_type: "index",
        table_name: "authbus_outbox",
        required_sql_fragments: &[
            "create index",
    ...
    SchemaObjectSpec {
        ...
        required_sql_fragments: &[
            ...
            "on authbus_outbox",
            "raise(abort",
            "authbus message content is immutable",
        ],
    },
    SchemaObjectSpec {
        name: "authbus_outbox_transition",
        object_type: "trigger",
        table_name: "authbus_outbox",
        required_sql_fragments: &[
            "before update on authbus_outbox",
            "old.state in ('acked', 'expired', 'quarantined')",
            "new.fence != old.fence + 1",
            "new.updated_at_ms < old.updated_at_ms",
            "raise(abort",
            "invalid authbus ownership transition",
        ],
    },
    SchemaObjectSpec {
        name: "authbus_outbox_active_no_delete",
        object_type: "trigger",
        table_name: "authbus_outbox",
        required_sql_fragments: &[
            "before delete on authbus_outbox",
            "old.state in ('queued', 'leased')",
            "raise(abort",
            "active authbus messages cannot be pruned",
        ],
    },
    SchemaObjectSpec {
    ...
    SchemaObjectSpec {
        name: "authbus_policy_versions",
        object_type: "table",
        table_name: "authbus_policy_versions",
        required_sql_fragments: &[
            "create table",
            "policy_id",
            "revision",
    ...
    SchemaObjectSpec {
        name: "authbus_policy_versions_no_update",
        object_type: "trigger",
        table_name: "authbus_policy_versions",
        required_sql_fragments: &["before update", "authbus policy versions are immutable"],
    },
    SchemaObjectSpec {
        name: "authbus_policy_versions_no_delete",
        object_type: "trigger",
        table_name: "authbus_policy_versions",
        required_sql_fragments: &["before delete", "authbus policy versions are immutable"],
    },
    SchemaObjectSpec {
        name: "authbus_policy_heads_no_delete",
        object_type: "trigger",
        table_name: "authbus_policy_heads",
        required_sql_fragments: &["before delete", "authbus policy heads cannot be deleted"],
    },
    SchemaObjectSpec {
    ...
    SchemaObjectSpec {
        name: "authbus_quota_registry_no_delete",
        object_type: "trigger",
        table_name: "authbus_quota_registry",
        required_sql_fragments: &["before delete", "authbus quota registry cannot be deleted"],
    },
    SchemaObjectSpec {
        ...
        required_sql_fragments: &[
            ...
            "'active', 'settled', 'cancelled', 'expired', 'quarantined'",
            "foreign key(quota_key)",
            "without rowid",
        ],
    },
    SchemaObjectSpec {
        name: "authbus_quota_reservations_quota_state",
        object_type: "index",
        table_name: "authbus_quota_reservations",
        required_sql_fragments: &["create index", "quota_key, state, reservation_id"],
    },
    SchemaObjectSpec {
        name: "authbus_quota_reservations_expiry",
        object_type: "index",
        table_name: "authbus_quota_reservations",
        required_sql_fragments: &["create index", "state, expires_at_ms, reservation_id"],
    },
    SchemaObjectSpec {
        name: "authbus_quota_reservations_transition",
        object_type: "trigger",
        table_name: "authbus_quota_reservations",
        required_sql_fragments: &["before update", "invalid authbus reservation transition"],
    },
    SchemaObjectSpec {
        name: "authbus_quota_reservations_no_delete",
        object_type: "trigger",
        table_name: "authbus_quota_reservations",
        required_sql_fragments: &["before delete", "authbus reservations are retained for reconciliation"],
    },
    SchemaObjectSpec {
        name: "authbus_issuer_registry",
        object_type: "table",
    ...
    SchemaObjectSpec {
        name: "authbus_issuer_heads",
        object_type: "table",
        table_name: "authbus_issuer_heads",
        required_sql_fragments: &[
            "create table",
    ...
    SchemaObjectSpec {
        name: "authbus_issuer_registry_identity_immutable",
        object_type: "trigger",
        table_name: "authbus_issuer_registry",
    ...
    SchemaObjectSpec {
        ...
        object_type: "trigger",
        table_name: "authbus_issuer_registry",
        required_sql_fragments: &["before delete", "authbus issuer registry entries cannot be deleted"],
    },
    SchemaObjectSpec {
        name: "authbus_issuer_heads_no_delete",
        object_type: "trigger",
        table_name: "authbus_issuer_heads",
        required_sql_fragments: &["before delete", "authbus issuer heads cannot be deleted"],
    },
    SchemaObjectSpec {
        name: "authbus_replay_retired_epochs",
        object_type: "table",
        table_name: "authbus_replay_retired_epochs",
        required_sql_fragments: &[
            "create table",
            "retired_checkpoint_generation",
            "primary key(issuer_id, key_epoch)",
            "without rowid",
        ],
    },
    SchemaObjectSpec {
        name: "authbus_replay_retired_epochs_no_update",
        object_type: "trigger",
        table_name: "authbus_replay_retired_epochs",
        required_sql_fragments: &["before update", "authbus retired replay epochs are immutable"],
    },
    SchemaObjectSpec {
        name: "authbus_replay_retired_epochs_no_delete",
        object_type: "trigger",
        table_name: "authbus_replay_retired_epochs",
        required_sql_fragments: &["before delete", "authbus retired replay epochs cannot be deleted"],
    },
    SchemaObjectSpec {
        name: "authbus_rollback_guard",
        object_type: "table",
        table_name: "authbus_rollback_guard",
        required_sql_fragments: &[
            "create table",
    ...
    SchemaObjectSpec {
        name: "authbus_rollback_guard_no_delete",
        object_type: "trigger",
        table_name: "authbus_rollback_guard",
        required_sql_fragments: &["before delete", "authbus rollback guard cannot be deleted"],
    },
    SchemaObjectSpec {
