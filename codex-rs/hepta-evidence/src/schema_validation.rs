...
const REQUIRED_SCHEMA_OBJECTS: &[SchemaObjectSpec] = &[
    ...
    SchemaObjectSpec {
        name: "authbus_policy_history",
        object_type: "table",
        table_name: "authbus_policy_history",
        required_sql_fragments: &[
            "create table",
            "scope_digest",
            "length(revision) = 8",
    ...
    SchemaObjectSpec {
        name: "authbus_policy_history_no_update",
        object_type: "trigger",
        table_name: "authbus_policy_history",
        required_sql_fragments: &[
            "before update on authbus_policy_history",
            "raise(abort",
            "authbus policy history is immutable",
        ],
    },
    SchemaObjectSpec {
        name: "authbus_policy_history_no_delete",
        object_type: "trigger",
        table_name: "authbus_policy_history",
        required_sql_fragments: &[
    ...
    SchemaObjectSpec {
        name: "authbus_quota_history",
        object_type: "table",
        table_name: "authbus_quota_history",
        required_sql_fragments: &[
            "create table",
            "quota_key",
            "length(revision) = 8",
    ...
    SchemaObjectSpec {
        name: "authbus_quota_history_no_update",
        object_type: "trigger",
        table_name: "authbus_quota_history",
        required_sql_fragments: &[
            "before update on authbus_quota_history",
            "raise(abort",
            "authbus quota history is immutable",
        ],
    },
    SchemaObjectSpec {
        name: "authbus_quota_history_no_delete",
        object_type: "trigger",
        table_name: "authbus_quota_history",
        required_sql_fragments: &[
    ...
    SchemaObjectSpec {
        ...
        required_sql_fragments: &[
            "create table",
            "length(reservation_id) = 32",
            "operation_id text not null unique",
            "'reserved', 'in_flight', 'settled', 'cancelled', 'expired', 'quarantined'",
            "foreign key (quota_key) references authbus_quota_registry(quota_key)",
            "without rowid",
        ],
    },
    SchemaObjectSpec {
        name: "authbus_quota_reservations_state_expiry",
        object_type: "index",
        table_name: "authbus_quota_reservations",
        required_sql_fragments: &[
            "create index",
            "authbus_quota_reservations(state, expires_at_ms, quota_key)",
        ],
    },
    SchemaObjectSpec {
        ...
        required_sql_fragments: &[
            ...
            "authbus reservation identity is immutable",
        ],
    },
    SchemaObjectSpec {
        name: "authbus_quota_reservation_transition",
        object_type: "trigger",
        table_name: "authbus_quota_reservations",
        required_sql_fragments: &[
            ...
            "invalid authbus reservation transition",
        ],
    },
    SchemaObjectSpec {
        name: "authbus_trust_heads",
        object_type: "table",
        table_name: "authbus_trust_heads",
        required_sql_fragments: &[
            "create table",
            "length(revision) = 8",
            "length(key_epoch) = 8",
            "length(verifying_key_digest) = 32",
            "length(registration_digest) = 32",
    ...
    SchemaObjectSpec {
        ...
        required_sql_fragments: &[
            "create table",
            "length(key_epoch) = 8",
            "length(checkpoint_generation) = 8",
            "primary key",
            "without rowid",
        ],
    },
    SchemaObjectSpec {
        ...
        required_sql_fragments: &[
            ...
            "authbus retired epochs are permanent",
        ],
    },
    SchemaObjectSpec {
        name: "authbus_replay_checkpoint",
        object_type: "table",
        table_name: "authbus_replay_checkpoint",
        required_sql_fragments: &[
            "singleton integer primary key",
            "singleton = 1",
            "length(generation) = 8",
            "length(replay_digest) = 32",
        ],
    },
    SchemaObjectSpec {
