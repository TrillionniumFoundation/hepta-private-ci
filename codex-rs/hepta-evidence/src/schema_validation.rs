...
const REQUIRED_SCHEMA_OBJECTS: &[SchemaObjectSpec] = &[
    ...
    SchemaObjectSpec {
        ...
        required_sql_fragments: &[
            ...
            "effect_digest",
            "binding_digest",
            "'active','effect_started','settled','cancelled','expired','quarantined'",
    ...
    SchemaObjectSpec {
        ...
        required_sql_fragments: &[
            ...
            "binding_digest",
            "raise(abort",
            "authbus reservation binding is immutable",
        ],
    },
    SchemaObjectSpec {
        ...
        required_sql_fragments: &[
            ...
            "old.state = 'active'",
            "old.state = 'effect_started'",
            "old.state = 'quarantined'",
            "invalid authbus reservation transition",
        ],
    },
    SchemaObjectSpec {
        name: "authbus_quota_reservation_held_no_delete",
        object_type: "trigger",
        table_name: "authbus_quota_reservations",
        required_sql_fragments: &[
            "before delete on authbus_quota_reservations",
            "old.state in ('active','effect_started','quarantined')",
            "held authbus reservations cannot be deleted",
        ],
    },
    SchemaObjectSpec {
