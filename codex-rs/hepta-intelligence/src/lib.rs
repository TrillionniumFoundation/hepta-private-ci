...
//! and the plasticity product adapter can retain governed next-generation proposals.
...
pub use plasticity_product::PlasticityProductErrorV1;
pub use plasticity_product::PlasticityProductEventSinkV1;
pub use plasticity_product::PlasticityProductEventV1;
pub use plasticity_product::PlasticityProductReceiptV1;
pub use plasticity_product::PlasticityProductRequestV1;
pub use plasticity_product::PlasticityProductStageV1;
pub use plasticity_product::run_governed_plasticity_v1;
