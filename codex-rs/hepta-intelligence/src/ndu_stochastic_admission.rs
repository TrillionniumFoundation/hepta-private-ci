...
pub fn canonical_ndu_stochastic_solver_digest_v1(
    ...
    for (field, digest) in [
        ...
        ("artifact_manifest", coefficient_profile.artifact_manifest_digest()),
        ("covariance_profile", coefficient_profile.covariance_profile_digest()),
        ("z_conversion_profile", coefficient_profile.z_conversion_profile_digest()),
        ("projection_source", projection.source_evidence_digest),
        ("projection_conversion", projection.conversion_receipt_digest),
