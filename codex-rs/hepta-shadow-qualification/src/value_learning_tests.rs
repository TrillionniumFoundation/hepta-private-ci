...
fn objective_to_ndu_to_independent_learning_ledger_is_replayable_and_revocable() {
    ...
    let utility_profile = UtilityProfile {
        ...
        axis_registry_digest: Digest32::of_bytes(b"utility-profile-axis-registry-v1"),
        normalization_manifest_digest: Digest32::of_bytes(
            b"utility-profile-normalization-v1",
        ),
    ...
    let policy = must(compatibility_evaluation_policy(&utility_profile));
