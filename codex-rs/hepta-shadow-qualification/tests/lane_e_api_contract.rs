...
fn lane_e_public_operation_surface_is_linkable() {
    ...
    let _ = codex_hepta_bellman_operator::VerifiedOperatorDatasetV2::from_authenticated_receipt;
    let _ = codex_hepta_bellman_operator::operator_dataset_signing_payload_v2;
