...
pub fn admit_manifest_at_withdrawal_head_v3(
    ...
    let withdrawal_scope_digest = registry
        .scope_digest()
        .ok_or(ArtifactAdmissionError::WithdrawalScopeRequired)?;
    let observed_head = registry.head_digest();
...
pub fn verify_artifact_admission_v3(
    ...
    if admission.withdrawal_scope_digest.is_zero() {
        return Err(ArtifactAdmissionError::WithdrawalScopeRequired);
    }
...
mod tests {
    ...
    #[test]
    fn art_05_admission_rejects_unscoped_withdrawal_registry() {
        ...
        assert_eq!(
            ...
            Err(ArtifactAdmissionError::WithdrawalScopeRequired)
        );
    }

    #[test]
    fn art_05_admission_is_domain_registry_and_scope_bound() {
