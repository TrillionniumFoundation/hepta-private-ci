...
pub fn admit_manifest_at_withdrawal_head_v3(
    ...
    let observed_binding = registry.binding_digest();
    ...
    Ok(WithdrawalBoundArtifactAdmissionV3 {
        validated_manifest,
        withdrawal_registry_binding_digest: observed_binding,
...
pub fn verify_artifact_admission_v3(
    ...
    current_withdrawal_registry_binding_digest: Digest32,
    ...
    if admission.withdrawal_registry_binding_digest != current_withdrawal_registry_binding_digest {
...
fn digest_admission(
    ...
    withdrawal_registry_binding_digest: Digest32,
    ...
    bytes.extend_from_slice(withdrawal_registry_binding_digest.as_array());
...
mod tests {
    ...
    fn art_05_admission_rejects_same_head_from_different_withdrawal_scope() {
        ...
        .expect("admission succeeds in original scope");

        assert_eq!(
            validate_artifact_publication_v3(&admission, &other_scope, 20),
