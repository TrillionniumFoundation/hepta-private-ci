...
pub fn inspect_artifact_owner_status_v1(
    ...
    ArtifactOwnerStatusV1 {
        ...
        lifecycle_head_digest,
        lifecycle_records,
        lifecycle_remaining_records: MAX_DURABLE_ARTIFACT_RECORDS.saturating_sub(lifecycle_records),
        status_digest,
...
mod tests {
    ...
    fn owner_status_is_bounded_read_only_and_scope_specific() {
        ...
        assert_ne!(
            status_a.withdrawal_head_digest,
            status_b.withdrawal_head_digest
        );
