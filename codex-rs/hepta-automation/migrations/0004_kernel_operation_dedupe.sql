...
-- The immutable dedupe receipt commits in the same transaction as the
-- automation task row. Exact replay returns the same destination fact while
-- semantic drift under the same operation identity conflicts.
