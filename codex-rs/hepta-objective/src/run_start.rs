...
pub struct RunStartSnapshotV1 {
    pub run_id: StableId,
    /// Digest of the exact canonical ObjectiveFunctionV1 JSON bytes.
    pub objective_digest: Digest32,
    /// Digest of the complete owner-local hard constraint set.
...
impl RunStartSnapshotV1 {
    ...
    pub fn bind(
        ...
        canonical_objective_digest: Digest32,
        ...
        let value = Self {
            run_id,
            objective_digest: canonical_objective_digest,
        ...
        value.validate_for_objective(objective, canonical_objective_digest)?;
        Ok(value)
    }
    ...
    pub fn validate_for_objective(
        ...
        validate_compiled_objective_v1(objective)?;
        if self.objective_digest != canonical_objective_digest {
