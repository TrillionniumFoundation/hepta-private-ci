...
fn snapshot() -> RunSnapshot {
    RunSnapshot {
        ...
        execution_payload_digest: digest('9'),
        authority_epoch: 7,
        deadline_ms: 10_000,
    }
}
    ...
    coordinator
        .start_run(
            ...
            RunSnapshot {
                ...
                execution_payload_digest: envelope.execution_payload_digest.to_string(),
                authority_epoch: 7,
                deadline_ms: 10_000,
            },
        )
...
fn v3_request() -> LaneFRunRequestV3 {
    ...
    LaneFRunRequestV3 {
        ...
        execution_payload_digest: v3_digest("execution-payload-v3"),
        snapshot,
        legal_candidates,
    ...
    coordinator
        .start_run(
            ...
            RunSnapshot {
                ...
                execution_payload_digest: request.execution_payload_digest.to_string(),
                authority_epoch: 1,
