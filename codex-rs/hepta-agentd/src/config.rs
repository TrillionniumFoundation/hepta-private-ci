...
pub struct AgentdConfig {
    ...
    intelligence_capability_trust_file: Option<PathBuf>,
...
impl AgentdConfig {
    ...
    pub fn load(
        ...
        Ok(Self {
            ...
            intelligence_capability_trust_file: None,
    ...
    /// Explicit owner-managed trust registry for intelligence V3 capability
    /// currentness. The daemon reloads this file at final use; callers cannot
    /// replace it with an injected verifier.
    pub fn with_intelligence_capability_trust_file(mut self, path: PathBuf) -> Self {
        self.intelligence_capability_trust_file = Some(path);
        self
    }

    pub(crate) fn intelligence_capability_trust_file(&self) -> Option<&Path> {
        self.intelligence_capability_trust_file.as_deref()
    }
