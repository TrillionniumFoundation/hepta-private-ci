...
pub struct AgentdConfig {
    ...
    browser_servo_config_file: Option<PathBuf>,
...
impl AgentdConfig {
    ...
    pub fn load(
        ...
        Ok(Self {
            ...
            browser_servo_config_file: None,
    ...
    pub fn with_browser_servo_config_file(mut self, path: PathBuf) -> Self {
        self.browser_servo_config_file = Some(path);
        self
    }

    pub(crate) fn browser_servo_config_file(&self) -> Option<&Path> {
        self.browser_servo_config_file.as_deref()
    }
