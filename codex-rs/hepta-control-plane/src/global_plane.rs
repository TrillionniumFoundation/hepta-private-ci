...
pub fn admit_fleet_allocation_owner_v1(
    ...
    let resource_profile_digest = canonical_resource_reservation_digest(&resource_reservations)?;
...
pub fn compose_global_plan_with_fleet_v1(
    ...
    planning_request.resource_profile_digest = fleet.resource_profile_digest;
