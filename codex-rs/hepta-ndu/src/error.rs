...
pub enum NduError {
    ...
    StateDigestMismatch,
    ConvergenceUnavailable(i64),
    InvalidHierarchyLink(String),
    DuplicateHierarchySubjectUpdate(String),
...
impl NduError {
    ...
    pub const fn code(&self) -> &'static str {
        match self {
            ...
            | Self::ConvergenceUnavailable(_) => "NDU-E008",
            Self::InvalidHierarchyLink(_)
            | Self::DuplicateHierarchySubjectUpdate(_)
...
impl fmt::Display for NduError {
    fn fmt(&self, formatter: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Self::ConvergenceUnavailable(residual) => write!(
                formatter,
            ...
            Self::DuplicateHierarchySubjectUpdate(subject) => write!(
                formatter,
                "subject {subject} has more than one update in the same generation"
            ),
