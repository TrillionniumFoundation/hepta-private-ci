...
impl AdmittedNduStochasticEvidenceV1 {
    #[must_use]
    pub fn binding(&self) -> &NduStochasticEvidenceBindingV1 {
        &self.binding
    }
...
pub struct BoundZEstimateV1 {
    ...
    stochastic_admission_digest: Digest32,
}

impl BoundZEstimateV1 {
    #[must_use]
    pub fn estimate(&self) -> &ZEstimateV1 {
        &self.estimate
    }

    #[must_use]
    pub const fn stochastic_admission_digest(&self) -> Digest32 {
        self.stochastic_admission_digest
    }
}
