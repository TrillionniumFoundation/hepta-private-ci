...
pub struct OutboxIntent {
    ...
    /// Canonical digest of the complete bound `OperationIntentV1`.
    pub operation_digest: Digest32,
}

impl OutboxIntent {
    pub fn for_operation(intent_id: StableId, operation: &OperationIntentV1) -> Self {
        Self {
            intent_id,
            operation_id: operation.operation_id().clone(),
            destination: operation.destination_id().clone(),
