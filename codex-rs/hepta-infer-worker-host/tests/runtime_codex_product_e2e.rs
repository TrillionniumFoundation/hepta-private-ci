...
#[allow(dead_code)]
#[path = "../../hepta-agentd/tests/support/fleet.rs"]
mod fleet_support;

use fleet_support::FleetHarness;
...
async fn real_agentd_app_server_caller_commits_one_authorized_terminal_turn() -> Result<()> {
