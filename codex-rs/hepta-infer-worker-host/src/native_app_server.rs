...
impl AppServerModelDriver {
    ...
    async fn run_once(
        ...
        // Bind the exact physical TurnStartParams before the durable dispatch
        // marker and App Server seam. The adapter remains DENY_ALL; independent
        // final-use authorization is a separate call-site gate, not something
        // this execution adapter is allowed to mint.
...
fn codex_receipt_for_notification(
