        ...
        SignRequest::ProductionGrant {
            ...
            let grant = signer
                .sign(
                    ...
                    *transition,
                    h7_envelope,
                    source_release_manifest_sha256.clone(),
                    target_release_manifest_sha256.clone(),
                    target_agentd_sha256.clone(),
                    target_matrixd_sha256.clone(),
                    compatibility_sha256.clone(),
                    revocation_frontier_sha256.clone(),
                    *expected_control_revision,
                    *expected_lifecycle_generation,
                    *authority_epoch,
                    *issued_at_unix_seconds,
...
mod tests {
    ...
    fn request_boundary_signs_and_verifies_production_grant() {
        ...
        let request = SignRequest::ProductionGrant {
            ...
            source_release_manifest_sha256: digest(11),
            target_release_manifest_sha256: digest(12),
            target_agentd_sha256: digest(13),
            target_matrixd_sha256: None,
            compatibility_sha256: digest(14),
            revocation_frontier_sha256: digest(15),
