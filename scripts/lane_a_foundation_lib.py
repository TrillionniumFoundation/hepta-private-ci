...
def validate_matrix(matrix: dict[str, Any], root: Path = ROOT) -> dict[str, Any]:
    ...
    exact = {
        ...
        ("auth.authbus", "implementation"): "signed_admission_policy_quota_reservation_control",
        (
            "auth.authbus",
            "durability",
        ): "sqlite_admission_outbox_policy_quota_reservations_and_process_local_legacy",
