...
def validate_source_specific(root: Path = ROOT) -> None:
    required = {
        ...
        "codex-rs/hepta-operations/src/durable/store.rs": [
        ...
        "codex-rs/hepta-operations/src/durable/reconcile.rs": [
        ...
        "codex-rs/hepta-operations/migrations/0002_retired_identity_tombstones.sql": [
