...
def validate_matrix(matrix: dict[str, Any], root: Path = ROOT) -> dict[str, Any]:
    ...
    exact = {
        ...
        ("auth.authbus", "implementation"): "signed_admission_and_durable_control_source_implemented",
        (
            "auth.authbus",
            "durability",
        ): "sqlite_policy_quota_reservation_replay_outbox_and_process_local_legacy",
