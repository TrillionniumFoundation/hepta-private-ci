    ...
    migrated.update(
        {
            "schema": "hepta.module-implementation-map.v3",
            "schemaVersion": 3,
            # A migrated map describes the source snapshot observed by this
            # migration run. Preserving a prior sourceBase makes every later
            # migration permanently stale even after implementation changes.
            "sourceBase": source_base,
