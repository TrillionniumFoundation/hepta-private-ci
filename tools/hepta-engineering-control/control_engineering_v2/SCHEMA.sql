...
CREATE TABLE IF NOT EXISTS distributed_write_frontiers(
...
CREATE INDEX IF NOT EXISTS idx_distributed_write_frontiers_coordinator
  ON distributed_write_frontiers(coordinator_id, leader_epoch, fencing_token);
